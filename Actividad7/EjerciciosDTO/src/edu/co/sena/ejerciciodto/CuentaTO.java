...
public class CuentaTO {
    ...
    public String toString() {
        return "Cuenta{" + "TipoDocumento=" + TipoDocumento + ", numeroDocumento=" + numeroDocumento + ", primerNombre=" + primerNombre + ", segundoNombre=" + segundoNombre + ", primerApellido=" + primerApellido + ", segundoApellido=" + segundoApellido + ", contrasena=" + contrasena + ", correo=" + correo + ", direccion=" + direccion + ", telefono=" + telefono + ", rool=" + rool + ", activo=" + activo + ", usuarioIdUsuario=" + usuarioIdUsuario + '}';
    }
