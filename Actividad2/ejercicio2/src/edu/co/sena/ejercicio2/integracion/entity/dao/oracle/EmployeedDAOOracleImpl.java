...
public class EmployeedDAOOracleImpl implements EmployeedDAO{
    ...
    public void insert(PeopleDTO e) {
        System.out.println("Se inserto el empleado en oracle: " +e.toString());
    }

    @Override
    public void update(PeopleDTO e) {
        System.out.println("Se actualizo el empleadp en oracle: " +e.toString());
    }

    @Override
    public void delete(PeopleDTO e) {
        System.out.println("Se borro el empleado en oracle: " +e.toString());
    }

    @Override
    public void findByID(PeopleDTO e) {
        System.out.println("Se busco el empleado en oracle: " +e.toString());
    }

    @Override
    public void inser(Collection<PeopleDTO> listaPersonas) {
        for (PeopleDTO listaPersona : listaPersonas) {
            System.out.println("Se inserto el empleado en oracle:  " + listaPersona.toString());
