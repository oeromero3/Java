...
public class EmployeedDAOMemoryImpl implements EmployeedDAO{
    ...
    public void insert(PeopleDTO e) {
       System.out.println("Se inserto el empleado en Memory: " +e.toString());
    }

    @Override
    public void update(PeopleDTO e) {
        System.out.println("Se actualizo el empleado en Memory: " +e.toString());
    }

    @Override
    public void delete(PeopleDTO e) {
        System.out.println("Se borro el empleado en Memory: " +e.toString());
    }

    @Override
    public void findByID(PeopleDTO e) {
        System.out.println("Se busco el empleado en Memory: " +e.toString());
    }

    @Override
    public void inser(Collection<PeopleDTO> listaPersonas) {
        for (PeopleDTO listaPersona : listaPersonas) {
            System.out.println("Se inserto el empleado en Memory:  " + listaPersona.toString());
